...
public abstract class AbstractPeakListPanel extends PopupTaskPanel implements MouseListener {
    ...
    public static final int MARGIN_TOP_BIG = 22,  MARGIN_TOP_MEDIUM = 14,  MARGIN_TOP_SMALL = 5;    // Components
    public JButton outputButton,  startButton;
    public TaskProgressBar progressBar = new TaskProgressBar();
    public File outputFile = null;    // Used for toggling names
    ...
    public AbstractPeakListPanel(int options, String description, Map<BigHash, String> filesToDownload) {
        ...
        // Set the inputs (read-only). Show filename if one file, else show file count.
        {
            ...
            JTextArea inputBox = new JTextArea(input);
    ...
    public void redrawForStart() {
        ...
        final Dimension d = new Dimension(
                (int) this.PREFERRED_DIMENSION.getWidth(),
                (int) this.PREFERRED_DIMENSION.getHeight() + 22);

        Thread t = new Thread("User-defined redraw thread") {

            public void run() {

                // Need to resize for progress bar
                frame.setSize(d);
    ...
    public void redrawForStop() {
        ...
        final Dimension d = this.PREFERRED_DIMENSION;
    ...
    public void setFilesToDownload(Map<BigHash, String> filesToDownload) {
